...
class rent_sale_filters(unittest.TestCase):
    ...
    def test_rent_sale_filters(self):
        success = True
        wd = self.wd
        wd.get("http://tvkinoradio.ru/catalog/video_13/videokameri-i-kamkorderi_128/")
        wd.find_element_by_xpath("//label[.='Только аренда']").click()
        if wd.current_url != "http://tvkinoradio.ru/catalog/video_13/videokameri-i-kamkorderi_128/?offerType=rent":
            success = False
        ...
        if wd.current_url != "http://tvkinoradio.ru/catalog/video_13/videokameri-i-kamkorderi_128/?offerType=sale":
            success = False
            print("verifyCurrentUrl failed")
        ...
        if wd.current_url != "http://tvkinoradio.ru/catalog/video_13/videokameri-i-kamkorderi_128/":
            success = False
            print("verifyCurrentUrl failed")
